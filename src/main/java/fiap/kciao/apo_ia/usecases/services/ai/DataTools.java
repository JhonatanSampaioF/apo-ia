...
public class DataTools {
    ...
    public String getContext() {
        ...
        for (Abrigado abrigado : abrigados) {
            ...
            for (Doenca doenca : abrigado.getDoencas()) {
            ...
            if (Boolean.TRUE.equals(abrigado.getVoluntario())) {
                ...
                for (Habilidade habilidade : voluntario.getHabilidades()) {
                    GrupoHabilidade grupoHabilidade = grupoHabilidadeQueryService.findByIdOrElseNull(habilidade.getGrupoHabilidade().getId());
